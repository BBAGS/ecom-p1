...
const Catalase = () => {
  ...
  return (
    <section className='mx-auto grid max-w-7xl grid-cols-4 gap-4 p-4'>
      ...
      <div className='col-span-4 grid w-full grid-cols-2 gap-4 sm:col-span-3 md:grid-cols-3 lg:grid-cols-4'>
